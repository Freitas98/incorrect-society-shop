...
### Provador virtual — evolução local de 2026-09-07

Consultar `docs/TRY-ON-V2.md` para arquitetura, medidas, evidências e validações pendentes. `docs/TRY-ON.md` preserva a primeira versão como histórico. A V2 parte do redesign publicado pelo utilizador (`ff35b21`), mas estas novas alterações não foram publicadas nem sincronizadas com a Shopify.
